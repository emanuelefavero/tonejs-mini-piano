...
// IF NOT MOBILE, PLAY SOUND ON MOUSE CLICK
if (isMobile === false) {
    ...
    for (let i = 0; i < document.querySelectorAll(".key").length; i++) {
        ...
        document.querySelectorAll(".key")[i].addEventListener("touchstart", function () {
    ...
    // RELOAD BUTTON
    const reset = document.querySelector('#reset').addEventListener('touchstart', () => {
        location.reload();
    });
...
const themeButton = document.querySelector('#themeButton').addEventListener('click', () => {
    document.querySelector('main').classList.toggle('theme');

    for (let i = 0; i < document.querySelectorAll('label').length; i++) {
        document.querySelectorAll('label')[i].classList.toggle('theme');
    }

    document.querySelector('section.keyboard').classList.toggle('invert');
    document.querySelector('button.theme-button').classList.toggle('theme');
});
