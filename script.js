...
function makeSound(key) {
  ...
  switch (key) {
    case 'a':
      Tone.loaded().then(() => {
        sampler
          .triggerAttackRelease(['C3'], 1)
          .chain(fx1, fx2, Tone.Destination)
      })
      break
    case 's':
      Tone.loaded().then(() => {
        sampler
          .triggerAttackRelease(['D3'], 1)
          .chain(fx1, fx2, Tone.Destination)
      })
      break
    case 'd':
